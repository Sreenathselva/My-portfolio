      ...
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => (
          ...
          className="flex justify-start pt-10 md:pt-40 md:gap-10">
            {/* desktop view */}
            <div
              className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start
               max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute w-10 rounded-full
                flex items-center justify-center bg-midnight left-[-15px]">
                <div
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              text-neutral-300 text-left md:hidden">
