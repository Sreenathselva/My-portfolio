export const myProjects = [
  {
    ...
    description:
      "A clean, modern travel landing page showcasing popular destinations and tours with eye-catching visuals that invite users to explore exciting vacation options.",
    subDescription: [
      "Developed a modern and visually engaging travel website with a clean, user-friendly interface.",
      "Implemented smooth sliders and interactive sections using Swiper.js to enhance user engagement.",
      "Designed a fully responsive layout using HTML, SCSS, and CSS for seamless experience across devices.",
      "Added dynamic interactions and animations with JavaScript to improve overall UI/UX flow.",
    ],
    href: "https://majestic-dango-c3e298.netlify.app",
    logo: "",
